    ...
    return (
        <div className='gig'>
            <div className='container'>
                <div className='left'>
                    <span className='beadCrumbs'>{`LIVERR > GRAPHICS & DESIGN >`}</span>
                    <h1>I will create ai generated art for you</h1>

                    <div className='user'>
                        <img
                            className='pp'
                            src='/img/pexels-photo-720327.webp'
                            alt=''
                        />
                        <span>Anna Bell</span>
                        <div className='stars'>
                    ...
                    <Slider
                        ...
                        className='slider'
                    >
                        <img src='/img/pexels-photo-1074535.jpeg' alt='' />
                        <img src='/img/pexels-photo-1462935.jpeg' alt='' />
                        <img src='/img/pexels-photo-1054777.webp' alt='' />
                    </Slider>
                    ...
                    <div className='seller'>
                        ...
                        <div className='user'>
                            <img src='/img/pexels-photo-720327.webp' alt='' />
                            <div className='info'>
                                <span>Anna Bell</span>
                                <div className='stars'>
                                    <img src='/img/star.png' alt='' />
                    ...
                    <div className='reviews'>
                        ...
                        <div className='item'>
                            <div className='user'>
                                <img
                                    className='pp'
                                    src='/img/pexels-photo-839586.webp'
                                />
                                <div className='info'>
                                    <span>John Doe</span>
                        ...
                        <div className='item'>
                            <div className='user'>
                                <img
                                    className='pp'
                                    src='/img/pexels-photo-4124367.jpeg'
                                    alt=''
                                />
                                <div className='info'>
                        ...
                        <div className='item'>
                            <div className='user'>
                                <img
                                    className='pp'
                                    src='/img/pexels-photo-842980.jpeg'
                                    alt=''
                                />
                                <div className='info'>
